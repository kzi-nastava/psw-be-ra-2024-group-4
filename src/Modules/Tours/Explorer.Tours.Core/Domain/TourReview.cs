...
namespace Explorer.Modules.Core.Domain
{
    public class TourReview : Entity
    {
        ...
        public TourReview(long idTour, long idTourist, int rating, string comment, DateTime? dateTour, DateTime? dateComment, List<string> images, double percentageCompleted)
        {
