INSERT INTO tours."KeyPoints"(
	...
	VALUES (-1, 'Colosseum, Rome', 12.4922, 41.8902, 'It is located just a few hundred meters away from the city center, at the northernmost point of Rome historic center.', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPd_FbzQUocKtjn8O2DFiQIrVQcZQgP5BU1MWzaDSMrw&s', 2, -1);
...
INSERT INTO tours."KeyPoints"(
	"Id", "Name", "Longitude", "Latitude", "Description", "Image", "UserId", "TourId")
	VALUES (-3, 'Sistine Chapel, Vatican City', 12.4545, 41.9029,  'Sistine Chapel is a large historic chapel and one of the papal facilities located in Vatican City and famous with its amazing frescoes made by Michelangelo and other artists.', 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Sistina-interno.jpg/640px-Sistina-interno.jpg', 2, -1);