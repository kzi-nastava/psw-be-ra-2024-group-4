...
namespace Explorer.Blog.Core.UseCases
{
    public class AdvertisementService : CrudService<AdvertisementDto, Advertisement>, IAdvertisementService
    {
        ...
        public IAdvertisementStakeholdersService _advertisementUserService;
        public AdvertisementService(ICrudRepository<Advertisement> crudRepository, IMapper mapper, IAdvertisementStakeholdersService advertisementUserService) : base(crudRepository, mapper)
        {
